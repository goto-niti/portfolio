...
document.addEventListener("DOMContentLoaded", function () {
  ...
  /* ------------------------
     Theme toggle (dark/light) - DISABLED, DARK MODE ONLY
     ------------------------ */
  ...
  // Simplified function - no need to redraw for theme changes since we only have dark mode
  function redrawAllGauges() {
  ...
  function drawGauge(canvas, percentTarget) {
    ...
    function step(){
      ...
      // text - Always light text for dark mode
